...
import controller.testing.CrossMatchDetailController;
...
public class CrossMatch extends javax.swing.JInternalFrame {
    ...
    SampleDetailsController sdetailController;
     ...
     */
    public CrossMatch(String requestNo, Requests parent) throws IOException {
        initComponents();
        ...
        sdetailController = new SampleDetailsController();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(donorsComboBox, 0, 298, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void markCrossMatchedButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_markCrossMatchedButtonActionPerformed
        if (dtmCom.getRowCount() == 0) {
            ...
            for (int i = 0; i < dtmCom.getRowCount(); i++) {
                ...
                String doneByName = ((String) medOfficerComboBox.getSelectedItem()).trim();
                String doneByID;
                try {
